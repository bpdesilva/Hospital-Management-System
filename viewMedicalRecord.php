...
echo '<script>alert("Databse has failded to connect!");</script>';//database connection fail message
        ...
        $sql = "SELECT * FROM medical_record,patient,doctor WHERE medical_record.patient_id=patient.no && medical_record.doctor_id=doctor.id";
...
<!--main content start-->
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-file-text-o"></i> View Medical Records</h3>
				</div>
			</div>
              ...
              <table class="table table-striped table-advance table-hover" id="myTable">
                           <tbody>
                              <tr>
                                 ...
                                 <th><i class="icon_mobile"></i>Issued Date</th>
                                 <th><i class="icon_pin_alt"></i>Issued Time</th>
                              </tr>
                             ...
                             <?php 
                               ...
                               foreach($OUTPUT as $value)
                               {
                                ...
                                echo"<td>Dr.".$value['name']."</td>";
                                echo"<td>".$value['description']."</td>";
                                   
                                   $issued_date = substr($value['issued_date'], 0, -8);
                                   $issued_time = substr($value['issued_date'], 11);
              ...
              <?php 
                               //Load data to model using the id of the selected row
                               foreach($OUTPUT as $value)
                               {
